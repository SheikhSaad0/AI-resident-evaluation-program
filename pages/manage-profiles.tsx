// pages/manage-profiles.tsx
import { useState } from 'react';
import { GlassTabs, GlassCard } from '../components/ui';
...
const ManageProfilesPage = () => {
    const tabs = [
        ...
        { id: 'directors', label: 'Program Directors', content: <ProgramDirectorManager /> },
    ];
    ...
    return (
        <div className="space-y-8">
            <div className="text-center lg:text-left">
                ...
                <p className="text-text-tertiary text-lg">Add, edit, or remove user profiles from the system.</p>
            </div>
